...
import 'package:smart/models/facebook_model.dart';
...
/*
    // For null checks, use (??) instead of (!)
...
*/
    if (userProfiloe == null) {
      // Code
      print('userProfiloe is null');
    } else {
      print('debug 2: $userProfiloe');
      print('debug 2: ${userProfiloe?.displayName}');
